...
public class HomeControllerTests {
    ...
    public void test_getHomePageObjectJSON() throws Exception {
        ...
        team.add("Daniel Lyu");
        team.add("Rick T. Zhang");
        team.add("Peak Manopchantaroj");
        team.add("Yulin Lin");
        team.add("George Nebieridze");
        team.add("Sanjay Srikanth");
        resultMap.put("team", team);
        resultMap.put("repo", "https://github.com/ucsb-cs156-s24/team01-s24-5pm-1");
